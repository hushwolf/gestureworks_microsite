...
<head>
	...
	<title>401 Error - GestureWorks</title>
		...
		<div id="homepg" style="height:480px;">
			...
			<section id="legal_container">
				<div id="legal_innercontainer">
					<h1 class="headerone black">HTTP Error 401</h1>
    ...
    <section class="clearfix">
      ...
      <article class="clearfix">
        ...
        <div class="interior">
          ...
          <p id="error">
            <strong>Unauthorized Access</strong> - you have attempted to access a page for which you do not have sufficient permissions. 
          </p>
