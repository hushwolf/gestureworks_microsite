...
<head>
	...
	<title>404 Error - GestureWorks</title>
...
<body id="legal">
	...
	<section id="main-content" style="height:1000px;">
		...
		<div id="homepg" style="height:480px;">

			<section id="legal_container">
				<div id="legal_innercontainer">
					<h1 class="headerone black">HTTP Error 404</h1>
    ...
    <section class="clearfix">
      ...
      <article class="clearfix">
        ...
        <div class="interior">
          ...
          <p id="error">
            <strong>File Not Found</strong> - the resource you are looking for was not found: it may have been moved, had its name changed, or be temporarily unavailable. 
          </p>
          
          <p class="tablet-n-desktop">
            Please try one or more of the following:
          </p>
          
          <p>
            If you typed the address, please make sure it is correct.<br>
            Go to the <a href="/">Home page</a> and look for links that lead to the desired resource.<br>
            Return to the <a href="javascript:history.go(-1)">last page</a> you were on and try again.<br>
            Report the issue (with all pertinent details) through the <a 
            href="http://ideum.com/contact/" target="_blank">Contact form</a>.
          </ul>
