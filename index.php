...
<body>
	...
	<header id="header">
		...
		<div id="header-maincontainer">
			...
			<div id="gestureworks_icon" class="vertcenter">
				...
				<a href="http://gestureworks.com" target="_blank">
	...
	<div id="homepg">
		...
		<section id="software_support_container">
			<img id="table_sales_img" src="images/mobile/290-sec-sales-img.png" class="phone">
			<img id="table_sales_img" src="images/mobile/720-sec-sales-img.jpg" class="vertcenter tablet">
