...
<html>
<head>
	<title>New Gesturework Core Microsite</title>
	<meta charset="UTF-8" />
	...
	<div id="homepg">
		...
		<section id="advanced_framework_container">
			<div id="advanced_framework_innercontainer" class="vertcenter">
				<h1 class="headerone black">Advanced Multitouch Framework for Windows</h1>
		...
		<footer>
			...
			<ul id="footer">
				...
				<li class="footerlink white"><a href="http://wiki.gestureworks.com/doku.php" target="_blank">WIKI</a></li>
